package jp.co.soramitsu.substrate_sdk.runtime.definitions

import com.ionspin.kotlin.bignum.integer.BigInteger
import jp.co.soramitsu.substrate_sdk.runtime.definitions.dynamic.DynamicTypeResolver
...
import jp.co.soramitsu.substrate_sdk.runtime.definitions.registry.create
...
import jp.co.soramitsu.substrate_sdk.runtime.definitions.types.composite.CollectionEnum
...
class TypeDefinitionsTree(
    ...
    class Versioning(
        @SerialName("runtime_range") val range: List<Int?>,
        val types: Map<String, Any>
    ) {
        val from: Int
            get() = range.first()!!
                ...
                when (typeValueCasted["type"]) {
                    ...
                    TOKEN_SET -> {
                        ...
                        val valueList = valueListRaw.mapValues { (_, value) ->
                            BigInteger.parseString(value.toInt().toString())
                        }
