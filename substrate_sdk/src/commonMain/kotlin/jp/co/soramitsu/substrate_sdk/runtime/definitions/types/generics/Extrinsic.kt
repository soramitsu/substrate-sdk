...
import jp.co.soramitsu.substrate_sdk.runtime.definitions.types.bytes
...
object Extrinsic : Type<Extrinsic.Instance>("ExtrinsicsDecoder") {
    ...
    override fun decode(scaleCodecReader: ScaleCodecReader, runtime: RuntimeSnapshot): Instance {
        val length = compactIntScale.read(scaleCodecReader)

        val extrinsicVersion = byteScale.read(scaleCodecReader).toUByte()
    ...
    override fun encode(
        ...
        val extrinsicVersion = runtime.metadata.extrinsic.version.intValue(exactRequired = true).toUByte()
